...
*   Matteo Varvello, Kleomenis Katevas, Mihai Plesa, Hamed Haddadi, Fabian Bustamante, Bel Livshits,  "[BatteryLab](https://batterylab.dev){:target="_blank"}: A Collaborative Platform for Power Monitoring", Passive and Active Measurement Conference 2022 ([PAM'22](https://pam2022.nl){:target="_blank"}), March 28–30, Online (Paper available on [BatteryLab](https://batterylab.dev){:target="_blank"} website) 
