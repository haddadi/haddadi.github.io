...
### Artur Laksberg, Microsoft: Programming IoT Edge Devices: Cloud-Client Duality
...
### Saman Naderiparizi, University of Washington: Battery-free Cameras and Low-power Machine Vision for IoT
...
### Joshua Smith, University of Washington: Battery-free Cellphone
...
Video cameras are increasingly appearing for surveilence and connected cars and other areas. The local processing versus cloud-based approaches are used in this space, though this depends on the type of analytics which are of interest (summeries, anomalies, highlights, etc). Edge computing can provide more efficent bandwidth provision here. Bandwidth constraint, the energy tradeoffs, low-latency, and analytics are of interest here. Local processing and adaptive algorithms can help with achieving the right tradeoff. 
...
Presented the Databox – open source project; personal data ecosystem; 
