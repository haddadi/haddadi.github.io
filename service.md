...
2011-2012: QMUL ELE403 Internet Protocols (UG) with Maged Elkashlan  
...
*   8th EAI International Conference on Mobile Computing, Applications and Services ([MobiCASE 2016](http://mobicase.org/2016/show/home))

*   ACM [SIGCOMM 2016](http://conferences.sigcomm.org/sigcomm/2016/)

*   12th ACM SIGCOMM Asian Internet Engineering Conference ([AINTEC 2016](http://www.interlab.ait.ac.th/aintec2016/))[  
    ](http://www.icwsm.org/2016/)

*   Personal and Ubiquitous Computing ([PUC](http://www.springer.com/computer/hci/journal/779)) [Special Issue on Privacy and the Internet of Things](https://t.co/Orj4BFrx7i)[  
    ](http://www.icwsm.org/2016/)

*   1st ACM MobiSys International Workshop on Mobile Data ([MOBIDATA 2016](http://sigmobile.org/mobisys/2016/workshops/mobidata/index.php))[  
    ](http://www.icwsm.org/2016/)

*   3rd ACM MobiSys International Workshop on Physical Analytics ([WPA 2016](http://tiny.cc/wpa-16))[  
    ](http://www.icwsm.org/2016/)

*   2nd Annual International Conference on Computational Social Science ([ICCSS 2016](http://www.kellogg.northwestern.edu/news-events/conference/ic2s2/2016.aspx))  
    

*   The 10th Internationa AAAI conference on Web and Social Media ([ICWSM 2016](http://www.icwsm.org/2016/))

*   25th International World Wide Web Conference ([WWW 2016](http://www2016.ca/) , mobility track)

*   6th ACM International Digital Health conference ([DH 2016](http://www.acm-digitalhealth.org/) , Social Computing for Health Track co-Chair)
...
*   The 9th ACM International Conference on Web Search and Data Mining [(WSDM 2016)](http://www.wsdm-conference.org/2016/)

*   The 8th IFIP Traffic Monitoring and Analysis workshop ([TMA 2016](http://tma.ifip.org/2016/))

*   The 8th International Workshop on Hot Topics in Planet-­scale mObile computing and online Social neTworking ([HotPOST’16](http://hotpost16.weebly.com/))

*   5th IEEE Workshop on Smart Data Pricing ([SDP2016](http://www.tc.umn.edu/%7Essen/SDP2016/index.html) , with IEEE INFOCOM 2016)

*   IEEE 2nd Workshop on Legal and Technical Issues in Cloud Computing and the Internet of Things ([CLaw 2016](http://www.claw-workshop.org/2016/))

*   ACM Conference on emerging Networking EXperiments and Technologies ([CoNext 2015](http://conferences2.sigcomm.org/co-next/2015/))  

*   7th International Conference on Mobile Computing, Applications and Services ([MobiCASE 2015](http://mobicase.org/2015/)) 

*   ACM SIGCOMM 11th Asian Internet Engineering Conference [(AINTEC 2015)](http://www.interlab.ait.ac.th/aintec2015/)  

*   ACM Conference on Online Social Networks ([COSN 2015](http://cosn.acm.org/2015/))  

*   First International Workshop on Social Sensing ([SocialSens 2015](http://www3.nd.edu/%7Edwang5/SocialSens2015/))  

*   ACM [SIGCOMM 2015](http://conferences.sigcomm.org/sigcomm/2015/)  

*   Multi-Service Networks 2015 ([MSN 2015](http://coseners.net/msn2015/))  

*   IEEE  [GLOBECOM 2015](http://globecom2015.ieee-globecom.org/)  

*   9th AAAI International Conference on Weblogs and Social Media ([ICWSM 2015](http://www.icwsm.org/2015/index.php))  

*   5th IEEE International Conference on Distributed Computing Systems ([ICDCS 2015](http://icdcs-2015.cse.ohio-state.edu/))  

*   Data Natives Workshop, City University London ([Data Natives 2015](http://datanatives.strikingly.com/))  

*   12th IEEE International Conference on Ubiquitous Intelligence and Computing ([UIC 2015](http://www.cybermatics.org/SWC2015/UIC/UIC2015.htm))  

*   Seventh International Workshop on Traffic Monitoring and Analysis ([TMA 2015](http://tma-2015.cba.upc.edu/)) 

*   The 7th Annual Workshop on Simplifying Complex Networks for Practitioners ([SIMPLEX 2015](http://www.simplexconf.net))  

*   7th International Workshop on Hot Topics in Planet-­scale mObile computing and online Social neTworking ([HotPOST 2015](http://hotpost15.weebly.com/)) 

*   1st IEEE International Workshop on Legal and Technical Issues in Cloud Computing ([CLaw 2015](http://www.claw-workshop.org/2015/))  

*   Fourth IEEE Workshop on Smart Data Pricing ([SDP2015](http://www.tc.umn.edu/%7Essen/SDP2015/index.html) , with IEEE INFOCOM 2015)
*   The International Workshop on Cyber-Physical Cloud Computing (IEEE/ACM CPCC 2014)
*   Sixth International Conference on Mobile Computing, Applications and Services (MobiCASE 2014)
*   Propagation Phenomena in Real World Network, Springer Book, 2014
*   IEEE Workshop on Privacy and Anonymity for the Digital Economy (PADE 2014)
...
*   1st International Workshop on Hot Topics in Big Data & Networking (HotData’14, IEEE ICCCN)
*   TPC for 3rd Workshop on Smart Data Pricing (SDP2014 , with IEEE INFOCOM)
*   TPC for 5th Workshop on Simplifying Complex Networks (SIMPLEX 2014, with WWW Conference)
*   TPC for IEEE International Conference on Multimedia and Expo (ICME 2014)
*   TPC for 6th Workshop on Hot Topics in P2P computing & Online Social neTworking (HotPOST 2014)
*   IEEE/IFIP International Conference on Dependable Systems and Networks (DSN 2014)
*   TPC for IEEE GLOBECOM (2009, 2010, 2011, 2012, 2013, 2014)
*   EPSRC ITaaU workshop on Human-Data Interaction (HDI 2013 , co-chair)
*   TPC co-Chair for ACM SIGCOMM HotPlanet workshop 2013
*   TPC for 8th workshop on Secure Network Protocols (NPSec 2013 , with IEEE ICNP 2013)
*   TPC for IEEE LCN Workshop on Privacy and Anonymity in Digital Economy (PADE 2013)
*   TPC for 7th International AAAI Conference on Weblogs and Social Media (ICWSM 2013)
*   Organising Committee for 8th Workshop on Secure Network Protocols (NPSec 2013) in conjunction with ICNP 2013
*   TPC for World Wide Web Conference (WWW 2013)
*   TPC for IEEE International workshop on Hot Topics in P2P computing & Online Social Networking (HotPOST 2012, HotPOST 2013)
*   Shadow-heavy TPC for EuroSys 2013
*   TPC for Workshop on Open Resilient human-aware Cyber-physical Systems (WORCS-2013)
*   TPC for IEEE International Conference on Multimedia and Expo (ICME 2013)
*   TPC for The Internet, Interdisciplinarity & Innovation (In3): The first international conference on Internet Science 2013
*   TPC co-Chair for EuroSys workshop Measurement, Privacy, Mobility (MPM 2012)
*   Co-Chair for EPSRC workshop on communications and networks (COMNET 2012)
*   TPC for IEEE Symposium on Green Technology and Systems (ISGTS 2012)
*   TPC for ACM SIGMETRICS workshop on Privacy and Anonymity in Digital Economy (PADE 2012)
*   TPC for IEEE Symposium on Business, Engineering & Industrial Applications (ISBEIA 2012) TPC for IEEE International Power and Energy Conference (PECON 2012)
*   TPC for ACM HotPlanet 2012
*   TPC for IEEE International Workshop on Social Networks and TV (CCNC’2012 SNTV)
*   TPC for ACM CoNext Student Workshop (2011)
*   TPC for First International Workshop on Enterprise Cloud Computing (ECCPL 2011)
*   TPC for ICCCN 2011 Workshop on Social Interactive Media Networking and Applications (SIMNA 2011)
*   TPC for 4th Workshop on Pervasive Advertising (Pervasive 2011)
*   TPC for International Conference on Digital Information and Communication Technology (DICTAP 2011)
*   TPC for IEEE Workshop on Complex and Communication Networks (CCNet 2010)
*   TPC for IEEE CCNC Workshop on Social Networking 2011
*   TPC for Eurosys Social Network Systems 2009
*   TPC for IEEE ICUMT 2009
*   TPC for 1st International Workshop on Emerging Internet Applications (WEIA’09)
*   TPC for International Congress on Modelling and Simulation( ModSim’09)
*   Guest Editor for MASAUM Journal of Basic and Applied Sciences (MJBAS)
